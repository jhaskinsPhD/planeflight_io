...
def get_paths(camp, nested):
    ...
    if camp == 'UWFPS':
        if nested is False:
            ...
            base_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                        '/GEOS_CHEM/GC_RunDirs/gc_2x25_merra2_fullchem_base')
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/gc_2x25_merra2_fullchem_rs_ssa')
        else:
            # UWFPS 2017 Nested Grid
            base_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                        '/GEOS_CHEM/GC_RunDirs/nested_grid/UWFPS_base')
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/nested_grid/UWFPS_rs')
        ...
        if nested is False:
            ...
            base_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                        '/GEOS_CHEM/GC_RunDirs/gc_Kalamazoo_base')
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/gc_full_merra_47_2x25_2018_Kalamazoo')
        else:
            # Kalamazoo 2018 Nested Grid
            base_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                        '/GEOS_CHEM/GC_RunDirs/nested_grid/Kalamazoo_base')
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/nested_grid/Kalamazoo_rs')
        ...
        if nested is False:
            ...
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/gc_fullchem_47layer_merra2_WINTER/')
        else:
            # WINTER 2015 Nested Grid:
            base_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                        '/GEOS_CHEM/GC_RunDirs/nested_grid/winte_base/')
            mod_pth = ('/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao'
                       '/GEOS_CHEM/GC_RunDirs/nested_grid/winter_rs')

        dat_pth = '/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao/WINTER_2015_1min_Merged.nc'
        dvars = {
            'ClNO2': 'CIMS1_UW_ClNO2',
            'HCl': 'CIMS1_UW_ClH',
            'Cl2': 'CIMS1_UW_Cl2',
            'HOCl': 'CIMS1_UW_ClHO',
            'N2O5': 'CIMS1_UW_N2O5'}
