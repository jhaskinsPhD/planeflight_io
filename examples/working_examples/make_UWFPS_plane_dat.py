...
uwfps_path='/uufs/chpc.utah.edu/common/home/haskins-group1/data/Campaign_Data/Raw_Data/UWFPS_2017/data/UWFPS_2017_1min_Merged.nc'

# Load in UWFPS 2017 data: 
ds=xr.load_dataset(uwfps_path) 

# Set path to the input file we want to get a list of tracers from! 
inp_file='/uufs/chpc.utah.edu/common/home/haskins-group1/users/szhao/GEOS_CHEM/GC_RunDirs/gc_2x25_merra2_fullchem_base/geoschem_config_run_jan_to_apr_2017.yml'

# Set path to the directory where Planedat output files will be saved:
savedir ='/uufs/chpc.utah.edu/common/home/haskins-group1/data/Campaign_Data/GC_Input_Files/UWFPS_2017/PlaneDat_Inputs/2024_09_09-SHUYING/'
